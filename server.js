...
app.get('/api/version',(req,res)=>res.json({version:'CRAFTED-VISUAL-ADMIN-WORKFLOW-FIX-20260609-21', superadminFix:true, mediaLibrary:true, publicTopRibbon:false, publicAnalyticsMenu:false, adminLogin:true, time:new Date().toISOString()}));
