(function(){
  ...
  document.addEventListener('click', function(e){
    if(e.target && (e.target.classList.contains('lang-btn') || e.target.closest('.lang-btn'))) cvRefreshHomeJourneySoon();
  }, true);

  function boot(){ installWhatsApp(); injectHomeJourneySections(); setTimeout(injectHomeJourneySections, 900); setTimeout(injectHomeJourneySections, 1800); renderRecentlyViewed(); renderWishlistShelf(); }
