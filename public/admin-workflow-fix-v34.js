...
(function(){
  ...
  function token(){ return sessionStorage.getItem('cvAdminApiToken') || ''; }
  function session(){ try{return JSON.parse(sessionStorage.getItem('cvAdminSession') || 'null');}catch(e){return null;} }
  ...
  function getManualFabricsSource(){
    ...
    try{
      if(Array.isArray(window.manualFabrics)) return window.manualFabrics;
    }catch(e){}
    try{
  ...
  function setManualFabricsSource(next){
    ...
    try{ window.manualFabrics = window.manualFabrics || []; }catch(e){}
  }
  ...
  */
  ...
  function cv27Token(){ return sessionStorage.getItem('cvAdminApiToken') || ''; }
  ...
  */
  function cv28Get(name, fallback){ try{ return window[name] !== undefined ? window[name] : fallback; }catch(e){ return fallback; } }
  ...
  function cv28Token(){ return sessionStorage.getItem('cvAdminApiToken') || ''; }
...
(function(){
  ...
  async function publishCategories(){
    ...
    if(typeof publishSettings === 'function'){
      ...
      const token = sessionStorage.getItem('cvAdminApiToken') || '';
...
(function(){
  ...
  function adminToken(){
    return sessionStorage.getItem('cvAdminApiToken') || '';
  }
...
(function(){
  ...
  function esc(v){ return String(v ?? '').replace(/[&<>"']/g, c => ({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c])); }
  function msg(m,err){ if(typeof window.showAdminStatus==='function') window.showAdminStatus(m,!!err); else console[err?'error':'log'](m); }
  function getGlobal(name, fallback){ try{ return window[name] !== undefined ? window[name] : fallback; }catch(e){ return fallback; } }
