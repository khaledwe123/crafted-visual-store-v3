...
(function(){
  ...
  function priceHtml(p, size, fabric, color){
    try{ if(typeof priceHTML === 'function') return priceHTML(p, size, fabric, color || selectedColor); }catch(e){}
  ...
  function openStableModal(product, customize){
    ...
    function refreshPrice(){
      ...
      if(price) price.innerHTML = priceHtml(p, selectedSize, selectedFabric, selectedColor);
      syncGlobals();
    }
