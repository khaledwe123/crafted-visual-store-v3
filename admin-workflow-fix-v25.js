/*
  ...
  Focus: products inner controls, publishing, media-library image source, analytics period sync, menu action publishing, product fabric dropdown and upload deduplication.
*/
(function(){
  'use strict';
  ...
  function normalizeFabricArray(){
    try{
      if(typeof window.manualFabrics === 'undefined' || !Array.isArray(window.manualFabrics)) window.manualFabrics = [];
